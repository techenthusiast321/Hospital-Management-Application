  ...
  return userData && (
    <div className="max-w-lg flex flex-col gap-2 text-sm">

      {
        ...
        ?<label htmlFor="image">
          <div className="inline-block relative cursor-pointer">
            ...
            <img className="w-19 absolute bottom-12 right-12" src={image ? '':assets.upload_icon} alt="" />
          </div>
      ...
      <div className="mt-10">
        {
          isEdit
          ? <button onClick={updateUserProfileData} className="border border-indigo-500 px-8 py-2 rounded-full hover:bg-indigo-500 hover:text-white transition-all" >Save Information</button>
